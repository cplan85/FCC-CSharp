...
Console.WriteLine($"Our new product, Glorious Future offers a return of {newReturn:C2}. Given your current volume, your potential profit would be {newProfit:C2}.");
